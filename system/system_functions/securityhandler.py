...
class SecurityManager():
    def __init__(self, path):
        self.path = path
        self.base_data_dir = "./datasets/hymenoptera_data"
    ...
    def validate_path(self):
        ...
        # Block spaces, unicode, emojis, slashes and hidden folders by using a regex expression
        ...
        # Check if less than 5 images in a class folder
        ...
        # Check if more than 5000 images in a class folder
        ...
        # Prevent users from loading datasets at 500 MB or above
